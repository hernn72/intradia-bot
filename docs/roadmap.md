...
| B-04 | Fundamentales: magnitudes primarias con fecha de publicación; ratios en Python | BLOQUEADO(B0, OD-01). **D-39** (2026-09-20): antes de decidir OD-01 se sondea EODHD gratuito para ver si trae `filing_date`; sondeo listo en `evidence/2026-09-20-OD-01-eodhd-free/`, falta la API key | B-00 | por escribir |
