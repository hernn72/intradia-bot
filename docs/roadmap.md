...
| A-02 | Rehacer P2.3, P2.4 y P2.5 una sola vez sobre `071ddb2b…`, con RS alineada y línea 0; decidir el RR en el score → **GATE P2** | **PENDIENTE y desbloqueada**, **ficha escrita** el 2026-09-21 (GATE L0 cruzado el 2026-09-18; la auditoría de T-016 descartó que P2.5 arrastre un intervalo falso). Ojo: la población pasa de 107 a 103 (D-31) y a 93 (D-35), y la comparación con lo publicado debe declarar las tres; el estimador primario de INV-14 todavía no se publica por banda | GATE L0 | **T-013** |
