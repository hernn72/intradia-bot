...
| C-09 | **Respaldo del EOD europeo (D-40)**: segunda fuente solo para Europa, o caché local de barras consolidadas, o las dos. El proveedor **retira** por la noche una barra que ya sirvió, y el bot la vio la tarde anterior. Entra por B-00 (ficha de proveedor) si es fuente externa | PENDIENTE, **decidida la necesidad** (D-40), sin ficha | B-00 si es proveedor | por escribir |
